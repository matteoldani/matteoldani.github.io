...
// Decode a base64 string (embedded model data) into an ArrayBuffer so the
// geometry can load without a web server (works under the file:// protocol).
function watch_embedded_buffer(b64, handler) {
...
(function () {
    ...
    function GLDrawer(scale, ready_callback) {
        ...
        watch_embedded_buffer(WATCH_VERTICES_B64, function (buffer) {
        ...
        watch_embedded_buffer(WATCH_INDICES_B64, function (buffer) {
